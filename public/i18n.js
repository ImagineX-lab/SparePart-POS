const i18nDict = {
  ...
  si: {
    ...
    set_tax: "පෙරනිමි බදු %",
    set_fontSize: "අකුරු වල ප්‍රමාණය (Font Size)",
    font_small: "සාමාන්‍ය (Small)",
    font_medium: "ටිකක් ලොකු (Medium)",
    font_large: "ලොකු (Large)",
    font_xl: "ගොඩක් ලොකු (Extra Large)",
    set_save: "සුරකින්න (Save)",
    set_dataTitle: "දත්ත",
